...
// Validation force du mot de passe (8+, maj, min, chiffre, spécial)
require_once __DIR__ . '/app/bootstrap.php';
$pwdErrors = \App\Models\User::validatePassword($password);
if ($pwdErrors) {
    $_SESSION['pwd_errors'] = $pwdErrors;
    redirect('register_form.php?err=weak');
}
